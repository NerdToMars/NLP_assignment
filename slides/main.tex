...
\begin{frame}{Innovation 7: Ensemble Search -- Majority Vote Beats SOTA}
  ...
  \begin{itemize}\setlength{\itemsep}{0pt}
    \item \textbf{Majority vote, cross-version:} top-7 relaxed $+$ top-7 strict from each regime (wihtout preprocessing / with preprocessing) $\Rightarrow$ 28 candidates, \textbf{122{,}409 combinations}. Operates on BIO tag sequences -- every family is eligible.
